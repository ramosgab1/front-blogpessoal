  ...
  async function gerarNovaPostagem(e: ChangeEvent<HTMLFormElement>) {
    ...
    if (id != undefined) {
      ...
      try {
        ...
        toastAlerta('Postagem atualizada com sucesso', 'sucesso'); //Informa o tipo de toastAlerta "sucesso".
        retornar();
      } catch (error: any) {
        if (error.toString().includes('403')) {
          ...
          toastAlerta('Erro ao atualizar a Postagem', 'erro'); //Informa o tipo de toastAlerta "erro".
        }
      }
    } else {
      // Cadastrar postagem
      try {
        ...
        toastAlerta('Postagem cadastrada com sucesso', 'sucesso'); //Informa o tipo de toastAlerta "sucesso".
        retornar();
      } catch (error: any) {
        if (error.toString().includes('403')) {
          toastAlerta('O token expirou, favor logar novamente', 'info') //Informa o tipo de toastAlerta "info".
          ...
          toastAlerta('Erro ao cadastrar a Postagem', 'info'); //Informa o tipo de toastAlerta "erro".
        }
      }
    }
  }
