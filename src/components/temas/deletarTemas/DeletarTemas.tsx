...
function DeletarTema() {
    ...
    async function deletarTema() {
        try {
            ...
            toastAlerta('Tema apagado com sucesso', 'sucesso') //Informa o tipo de toastAlerta "sucesso".

        } catch (error) {
            toastAlerta('Erro ao apagar o Tema', 'erro') //Informa o tipo de toastAlerta "erro".
        }
